...
//         if (inputLine[i] == 'X')
//         {
//            obstacleObject = Instantiate<GameObject>(obstacle1);
//            obstacleObject.transform.position = new Vector3(Random.Range(-8f, 4f), 0, i * 30);
//         }
//
//         if (inputLine[i] == 'B')
//         {
//            obstacleObject = Instantiate<GameObject>(obstacle2);
//            obstacleObject.transform.position = new Vector3(Random.Range(-8f, 4f), 0, i * 100);
//         }
//      }
//   }
//}
